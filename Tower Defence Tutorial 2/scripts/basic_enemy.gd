...
@export var explosion_sprite:PackedScene
...
func _on_dying_state_entered():
	...
	explosion.global_position = $Path3D/PathFollow3D/Enemy.global_position
	print($Path3D/PathFollow3D/Enemy.global_position)
